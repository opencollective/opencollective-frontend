  ...
  describe('About section', () => {
    it('Can add a rich description', () => {
      ...
      cy.get('[data-cy="longDescription"]').should(
        'have.html',
        '<div><strong>Hello world!&nbsp;</strong><strong><iframe allowfullscreen="" referrerpolicy="strict-origin-when-cross-origin" width="100%" height="394" title="Embed content" src="https://www.youtube-nocookie.com/embed/2oyhlad64-s?showinfo=0"></iframe><figcaption></figcaption></strong></div>',
      );
    });
  });
});
