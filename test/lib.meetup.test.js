...
describe('meetup lib', () => {
  ...
  it('shows the list of backers if no sponsors', () => {
    const collectiveWithoutSponsors = Object.assign({}, collective, {
      users: collective.users.slice(1, 3),
    });
    const meetup = new Meetup(meetupAccount, collectiveWithoutSponsors);
    const header = meetup.makeHeader();
    const expectedHeader =
      '<p>Thank you to our backers <a href="https://twitter.com/piamancini">Pia</a> and <a href="https://twitter.com/xdamman">Xavier</a></p> <p><a href="https://opencollective.com/opencollective#backers"><img src="https://opencollective.com/opencollective/backers.png?width=700"></a></p>';
    expect(header).to.equal(expectedHeader);
  });

  it('adds/removes the header when no backers', () => {
    const collectiveWithoutBackers = Object.assign({}, collective, {
      users: [],
    });
    ...
    expect(descriptionWithHeader).to.equal(
      '<p><a href="https://opencollective.com/opencollective#backers"><img src="https://opencollective.com/opencollective/backers.png?width=700"></a></p> <p>Hello World</p>',
    );
