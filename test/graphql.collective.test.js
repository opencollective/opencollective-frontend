...
describe('Query Tests', () => {
  ...
  it('gets the collective info for the collective page', async () => {
    ...
    const memberships = userCollective.memberships;
    memberships.sort((a, b) => {
      `${a.slug}${a.role}` - `${b.slug}${b.role}`;
    })
