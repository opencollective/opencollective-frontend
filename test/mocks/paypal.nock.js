...
export default () => {
  nock('https://api.sandbox.paypal.com:443')
    ...
    .reply(
      200,
      {
        ...
        nonce:
          '2016-08-03T21:01:22ZcIbqjVI2MPTodCz4VkKZptGUDo0l77kE0W9HJCarniE',
        access_token:
      ...
      },
      {
        ...
        server: 'Apache',
        proxy_server_info:
          'host=slcsbplatformapiserv3002.slc.paypal.com;threadId=1401',
  ...
  nock('https://api.sandbox.paypal.com:443')
    .post('/v1/payments/billing-plans/', {
      ...
      merchant_preferences: {
        cancel_url:
          'http://localhost:3060/collectives/1/transactions/1/callback',
        return_url:
          'http://localhost:3060/collectives/1/transactions/1/callback',
      },
      payment_definitions: [
    ...
    .reply(
      201,
      {
        ...
        links: [
          {
            href:
              'https://api.sandbox.paypal.com/v1/payments/billing-plans/P-5XV712416S7754716XCYHPFI',
            rel: 'self',
            method: 'GET',
          },
        ],
      },
      {
        ...
        server: 'Apache',
        proxy_server_info:
          'host=slcsbplatformapiserv3001.slc.paypal.com;threadId=776',
  ...
  nock('https://api.sandbox.paypal.com:443')
    ...
    .reply(200, '', {
      ...
      server: 'Apache',
      proxy_server_info:
        'host=slcsbplatformapiserv3001.slc.paypal.com;threadId=385',
    ...
    .reply(
      201,
      {
        ...
        links: [
          {
            href:
              'https://www.sandbox.paypal.com/cgi-bin/webscr?cmd=_express-checkout&token=EC-9AN89060FV238992F',
            rel: 'approval_url',
            method: 'REDIRECT',
          },
          {
      ...
      },
      {
        ...
        server: 'Apache',
        proxy_server_info:
          'host=slcsbplatformapiserv3001.slc.paypal.com;threadId=276',
    ...
    .reply(
      201,
      {
        ...
        links: [
          {
            href:
              'https://api.sandbox.paypal.com/v1/payments/payment/PAY-5RY21717AN749961CK66JPNI',
            rel: 'self',
            method: 'GET',
          },
          {
            href:
              'https://www.sandbox.paypal.com/cgi-bin/webscr?cmd=_express-checkout&token=EC-81Y986204V302830H',
            rel: 'approval_url',
            method: 'REDIRECT',
          },
          {
            href:
              'https://api.sandbox.paypal.com/v1/payments/payment/PAY-5RY21717AN749961CK66JPNI/execute',
            rel: 'execute',
            method: 'POST',
          },
        ],
      },
      {
        ...
        server: 'Apache',
        proxy_server_info:
          'host=slcsbplatformapiserv3002.slc.paypal.com;threadId=581',
