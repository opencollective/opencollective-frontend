...
module.exports = () => {
  ...
  nock('https://api.sandbox.paypal.com:443')
    ...
    .reply(201, {"id":"P-5XV712416S7754716XCYHPFI","state":"CREATED","name":"Plan for donation of USD 10 / month to WWCode Austin","description":"donation of USD 10 / month to WWCode Austin","type":"INFINITE","payment_definitions":[{"id":"PD-2BF62477UT6951926XCYHPFI","name":"Regular payment","type":"REGULAR","frequency":"Month","amount":{"currency":"USD","value":"10"},"cycles":"0","charge_models":[],"frequency_interval":"1"}],"merchant_preferences":{"setup_fee":{"currency":"USD","value":"0"},"max_fail_attempts":"0","return_url":"http://localhost:3060/groups/1/transactions/1/callback","cancel_url":"http://localhost:3060/groups/1/transactions/1/callback","auto_bill_amount":"NO","initial_fail_amount_action":"CONTINUE"},"create_time":"2016-08-23T18:36:27.925Z","update_time":"2016-08-23T18:36:27.925Z","links":[{"href":"https://api.sandbox.paypal.com/v1/payments/billing-plans/P-5XV712416S7754716XCYHPFI","rel":"self","method":"GET"}]}, { date: 'Tue, 23 Aug 2016 18:36:27 GMT',
    server: 'Apache',
  ...
  nock('https://api.sandbox.paypal.com:443')
    ...
    .reply(201, {"name":"Agreement for donation of USD 10 / month to WWCode Austin","description":"donation of USD 10 / month to WWCode Austin","plan":{"id":"P-5XV712416S7754716XCYHPFI","state":"ACTIVE","name":"Plan for donation of USD 10 / month to WWCode Austin","description":"donation of USD 10 / month to WWCode Austin","type":"INFINITE","payment_definitions":[{"id":"PD-2BF62477UT6951926XCYHPFI","name":"Regular payment","type":"REGULAR","frequency":"Month","amount":{"currency":"USD","value":"10"},"cycles":"0","charge_models":[],"frequency_interval":"1"}],"merchant_preferences":{"setup_fee":{"currency":"USD","value":"0"},"max_fail_attempts":"0","return_url":"http://localhost:3060/groups/1/transactions/1/callback","cancel_url":"http://localhost:3060/groups/1/transactions/1/callback","auto_bill_amount":"NO","initial_fail_amount_action":"CONTINUE"}},"links":[{"href":"https://www.sandbox.paypal.com/cgi-bin/webscr?cmd=_express-checkout&token=EC-9AN89060FV238992F","rel":"approval_url","method":"REDIRECT"},{"href":"https://api.sandbox.paypal.com/v1/payments/billing-agreements/EC-9AN89060FV238992F/agreement-execute","rel":"execute","method":"POST"}],"start_date":"2016-08-23T18:36:33.479Z"}, { date: 'Tue, 23 Aug 2016 18:36:29 GMT',
    server: 'Apache',
  ...
  nock('https://api.sandbox.paypal.com:443')
    .post('/v1/payments/payment/', {"intent":"sale","payer":{"payment_method":"paypal"},"redirect_urls":{"return_url":"http://localhost:3060/groups/1/transactions/1/callback","cancel_url":"http://localhost:3060/groups/1/transactions/1/callback"},"transactions":[{"amount":{"currency":"USD","total":10},"description":"Donation to WWCode Austin (USD 10)"}]})
