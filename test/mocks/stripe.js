export default {
  ...
  bitcoin: {
    balanceTransaction: {
      ...
      net: 4960,
      source: 'py_1Bat4MDjPFcHOcTmnnycJGQn',
      sourced_transfers: {
        object: 'list',
        data: [
          {
            id: 'tr_1Bat4NDjPFcHOcTmchrFP1LJ',
            object: 'transfer',
            amount: 4710,
            amount_reversed: 0,
            balance_transaction: 'txn_1Bat4NDjPFcHOcTmW1PlPnIc',
            created: 1513720575,
            currency: 'usd',
            description: null,
            destination: 'acct_18KWlTLzdXg9xKNS',
            destination_payment: 'py_1Bat4NLzdXg9xKNS69FR7eDE',
            livemode: false,
            metadata: {},
            reversals: {
              object: 'list',
              ...
              has_more: false,
              total_count: 0,
              url: '/v1/transfers/tr_1Bat4NDjPFcHOcTmchrFP1LJ/reversals',
            },
            reversed: false,
            source_transaction: 'py_1Bat4MDjPFcHOcTmnnycJGQn',
            source_type: 'card',
            transfer_group: 'group_py_1Bat4MDjPFcHOcTmnnycJGQn',
            date: 1513720575,
            status: 'paid',
        ...
        has_more: false,
        total_count: 1,
        url: '/v1/transfers?source_transaction=py_1Bat4MDjPFcHOcTmnnycJGQn',
      },
      status: 'pending',
      type: 'payment',
    },
  ...
  createSubscription: {
    ...
    canceled_at: null,
    created: 1506398222,
    current_period_end: 1506916617,
    current_period_start: 1506398222,
    customer: 'cus_BT6ORKojThuNLn',
    discount: null,
    ended_at: null,
    items: {
      object: 'list',
      data: [
        {
          id: 'si_1B6ABuD8MNtzsDcgL7axnWRL',
      ...
      has_more: false,
      total_count: 1,
      url: '/v1/subscription_items?subscription=sub_BM7mrzF0w129va',
    },
    livemode: false,
    metadata: {
      from: 'http://localhost:3000/philmod',
      to: 'http://localhost:3000/scouts',
      PaymentMethodId: '4',
    },
    plan: {
      id: 'USD-MONTH-35000',
    ...
    status: 'trialing',
    tax_percent: null,
    trial_end: 1506916617,
    trial_start: 1506398222,
  },
