...
describe('lib.activities.test.js', () => {
  ...
  describe('formatMessageForPrivateChannel', () => {
    ...
    it (`${constants.GROUP_TRANSACTION_CREATED} donation`, () => {
      var actual = activitiesLib.formatMessageForPrivateChannel(activitiesData[12], 'slack');
    ...
    it (`${constants.USER_CREATED} all fields present`, () => {
      var actual = activitiesLib.formatMessageForPrivateChannel(activitiesData[0], 'slack');
    ...
    it (`${constants.USER_CREATED} only email present`, () => {
      var actual = activitiesLib.formatMessageForPrivateChannel(activitiesData[1], 'slack');
      expect(actual).to.equal('New user joined: someone (john@doe.com)');
    });

    it (constants.WEBHOOK_STRIPE_RECEIVED, () => {
      var actual = activitiesLib.formatMessageForPrivateChannel(activitiesData[15], 'slack');
      expect(actual).to.equal('Stripe event received: invoice.payment_succeeded');
    });

    it (constants.SUBSCRIPTION_CONFIRMED, () => {
      var actual = activitiesLib.formatMessageForPrivateChannel(activitiesData[16], 'slack');
    ...
    it (`${constants.SUBSCRIPTION_CONFIRMED} with month interval`, () => {
      var actual = activitiesLib.formatMessageForPrivateChannel(activitiesData[17], 'slack');
    ...
    it (constants.GROUP_CREATED, () => {
      var actual = activitiesLib.formatMessageForPrivateChannel(activitiesData[18], 'slack');
    ...
    it (constants.GROUP_USER_ADDED, () => {
      var actual = activitiesLib.formatMessageForPrivateChannel(activitiesData[19], 'slack');
    ...
    it (`${constants.GROUP_EXPENSE_CREATED}`, () => {
      var actual = activitiesLib.formatMessageForPrivateChannel(activitiesData[20], 'slack');
    ...
    it (`${constants.GROUP_EXPENSE_REJECTED}`, () => {
      var actual = activitiesLib.formatMessageForPrivateChannel(activitiesData[21], 'slack');
    ...
    it (`${constants.GROUP_EXPENSE_APPROVED}`, () => {
      var actual = activitiesLib.formatMessageForPrivateChannel(activitiesData[22], 'slack');
  ...
  describe('formatMessageForPublicChannel', () => {
    ...
    it (`${constants.GROUP_TRANSACTION_CREATED} donation`, () => {
      var actual = activitiesLib.formatMessageForPublicChannel(activitiesData[12], 'slack');
    ...
    it (`${constants.GROUP_TRANSACTION_CREATED} expense`, () => {
      var actual = activitiesLib.formatMessageForPublicChannel(activitiesData[13], 'slack');
    ...
    it (`${constants.GROUP_TRANSACTION_PAID} expense paid`, () => {
      var actual = activitiesLib.formatMessageForPublicChannel(activitiesData[14], 'slack');
      expect(actual).to.equal('Expense paid on <https://opencollective.com/pubquiz|Pub quiz>: USD -12.98 for \'pizza\'');
    });

    it (constants.SUBSCRIPTION_CONFIRMED, () => {
      var actual = activitiesLib.formatMessageForPublicChannel(activitiesData[16], 'slack');
      expect(actual).to.equal('New subscription confirmed: EUR 12.34 from someone to <https://opencollective.com/blah|Blah>!');
    });

    it (`${constants.SUBSCRIPTION_CONFIRMED} with month interval`, () => {
      var actual = activitiesLib.formatMessageForPublicChannel(activitiesData[17], 'slack');
    ...
    it (constants.GROUP_CREATED, () => {
      var actual = activitiesLib.formatMessageForPublicChannel(activitiesData[18], 'slack');
      expect(actual).to.equal('New group created: <https://opencollective.com/blah|Blah> by someone');
    });

    it (`${constants.GROUP_EXPENSE_CREATED}`, () => {
      var actual = activitiesLib.formatMessageForPublicChannel(activitiesData[20], 'slack');
      expect(actual).to.equal('New Expense: someone submitted an expense to <blah.com|Blah>: EUR 0.1234 for for pizza!');
    });

    it (`${constants.GROUP_EXPENSE_REJECTED}`, () => {
      var actual = activitiesLib.formatMessageForPublicChannel(activitiesData[21], 'slack');
      expect(actual).to.equal('Expense rejected: EUR 0.1234 for for pizza in <blah.com|Blah>!');
    });

    it (`${constants.GROUP_EXPENSE_APPROVED}`, () => {
      var actual = activitiesLib.formatMessageForPublicChannel(activitiesData[22], 'slack');
  ...
  describe('formatMessageForPublicChannel gitter format', () => {
    ...
    it (`${constants.SUBSCRIPTION_CONFIRMED} with month interval for Gitter`, () => {
      var actual = activitiesLib.formatMessageForPublicChannel(activitiesData[17], 'markdown');
