...
describe('lib.activities.test.js', () => {
  describe('formatMessageForPrivateChannel', () => {
    it(`${constants.COLLECTIVE_TRANSACTION_CREATED} donation`, () => {
      const actual = activitiesLib.formatMessageForPrivateChannel(
        activitiesData[12],
        'slack',
      );
    ...
    it(`${constants.USER_CREATED} all fields present`, () => {
      ...
      expect(actual).to.equal(
        'New user joined: <https://twitter.com/johndoe|John Doe> (john@doe.com)',
      );
    });
    ...
    it(`${constants.COLLECTIVE_EXPENSE_REJECTED}`, () => {
      ...
      expect(actual).to.equal(
        'Expense rejected: EUR 12.34 for for pizza in <blah.com|Blah> by userId: 2!',
      );
    });
    ...
    it(`${constants.COLLECTIVE_EXPENSE_APPROVED}`, () => {
      ...
      expect(actual).to.equal(
        'Expense approved: EUR 12.34 for for pizza in <blah.com|Blah> by userId: 2!',
      );
    });
  });
  ...
  describe('formatMessageForPublicChannel', () => {
    it(`${constants.COLLECTIVE_TRANSACTION_CREATED} donation`, () => {
      const actual = activitiesLib.formatMessageForPublicChannel(
        activitiesData[12],
        'slack',
      );
      expect(actual).to.equal(
    ...
    it(`${constants.COLLECTIVE_EXPENSE_PAID} expense paid`, () => {
      ...
      expect(actual).to.equal(
        "Expense paid on <https://opencollective.com/pubquiz|Pub quiz>: USD -12.98 for 'pizza'",
      );
    });
    ...
    it(constants.COLLECTIVE_CREATED, () => {
      ...
      expect(actual).to.equal(
        'New collective created by someone: <https://opencollective.com/blah|Blah>',
      );
    });
    ...
    it(`${constants.COLLECTIVE_EXPENSE_REJECTED}`, () => {
      ...
      expect(actual).to.equal(
        'Expense rejected: EUR 12.34 for for pizza in <blah.com|Blah>!',
      );
    });
    ...
    it(`${constants.COLLECTIVE_EXPENSE_APPROVED}`, () => {
      ...
      expect(actual).to.equal(
        'Expense approved: EUR 12.34 for for pizza in <blah.com|Blah>!',
      );
    });
  });
  ...
  describe('formatMessageForPublicChannel gitter format', () => {
    it(`${
      constants.SUBSCRIPTION_CONFIRMED
    } with month interval for Gitter`, () => {
      const actual = activitiesLib.formatMessageForPublicChannel(
        activitiesData[17],
        'markdown',
      );
