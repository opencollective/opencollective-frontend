...
export const resetTestDatabase = function(req, res, next) {
  ...
  const backerData = {
    ...
    lastName: 'Sood',
    image:
      'https://opencollective-production.s3-us-west-1.amazonaws.com/908fbcbca45e4a52a4309d00e980018c_e554f450-2127-11e6-9a76-e98f5a4a50b6.jpeg',
  };
  ...
  const backer2Data = {
    ...
    lastName: 'Mancini',
    image:
      'https://opencollective-production.s3-us-west-1.amazonaws.com/9EflVQqM_400x400jpg_2aee92e0-858d-11e6-9fd7-73dd31eb7c0c.jpeg',
  };
    ...
    sequelize
      ...
      .then(() =>
        models.PaymentMethod.create({
          ...
          type: 'adaptive',
          token: 'abc',
          CollectiveId: testHost.CollectiveId,
        }),
      )
      .then(() =>
        models.Order.create({
