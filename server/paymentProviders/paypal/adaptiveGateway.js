...
const callPaypal = (endpointName, payload) => {
  ...
  return new Promise((resolve, reject) => {
    paypalAdaptiveClient[endpointName](
      Object.assign({}, payload, { requestEnvelope }),
      (err, res) => {
...
const preapprovalDetails = preapprovalKey =>
  callPaypal('preapprovalDetails', { preapprovalKey });
