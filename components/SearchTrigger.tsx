...
const SearchTrigger = ({ setShowSearchModal }) => {
  ...
  return (
    <button
      className="relative flex h-8 w-8 items-center justify-center gap-1.5 rounded-full border text-slate-500 ring-black ring-offset-2 hover:bg-slate-50 focus:outline-none focus-visible:ring-2 lg:w-auto lg:justify-start lg:px-2 lg:pr-4"
