import { escape, startCase, toUpper } from 'lodash-es';

/**
 * Formats a bank account details, as generated by the Wise bank account form.
 * Keep this in sync with `opencollective-api/server/lib/transferwise.ts`
 */
