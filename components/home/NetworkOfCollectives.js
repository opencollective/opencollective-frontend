...
const collectives = [
  ...
  },
  {
    ...
    render: id => (
      <React.Fragment>
        <g className="visible-sm">
          <rect x="208.695" y="51.5992" width="64.604" height="64.5693" rx="32.2846" fill={`url(#${id})`} />
          <path
        ...
        <g className="visible-xs">
          <rect x="53" y="209" width="63" height="62" rx="31" fill={`url(#${id})`} />
          <path
  ...
  },
  {
    ...
    render: id => (
      <React.Fragment>
        <g className="visible-sm">
          <rect x="85.1399" y="49.1779" width="45.2228" height="45.1985" rx="22.5993" fill={`url(#${id})`} />
          <path
        ...
        <g className="visible-xs">
          <rect x="16" y="279" width="44" height="44" rx="22" fill={`url(#${id})`} />
          <path
  ...
  },
  {
    ...
    render: id => (
      <React.Fragment>
        <g className="visible-sm">
          <rect x="144" y="142" width="45.2228" height="45.1985" rx="22.5993" fill="white" />
          <rect x="144" y="142" width="45.2228" height="45.1985" rx="22.5993" fill={`url(#${id})`} />
          <path
        ...
        <g className="visible-xs">
          <rect x="72" y="330" width="44" height="43" rx="21.5" fill="white" />
          <rect x="72" y="330" width="44" height="43" rx="21.5" fill={`url(#${id})`} />
          <path
        ...
        >
          ...
          >
            ...
            <g className="visible-sm">
              ...
              <path d="M241 86L161 167" stroke="white" strokeWidth="4" />
              ...
              <path d="M493.761 184.773L240.997 83.8839" stroke="white" strokeWidth="4" />
