...
describe('CustomPaymentMethodInstructions', () => {
  ...
  describe('Rendering', () => {
    it('renders nothing for empty string', () => {
      const { container } = render(<CustomPaymentMethodInstructions instructions="" values={defaultValues} />);
    ...
    it('renders simple text without variables', () => {
      ...
      render(<CustomPaymentMethodInstructions instructions={instructions} values={defaultValues} />);
    ...
    it('formats currency amounts correctly', () => {
      ...
      render(<CustomPaymentMethodInstructions instructions={instructions} values={valuesWithLargeAmount} />);
    ...
    it('applies custom className', () => {
      ...
      const { container } = render(
        <CustomPaymentMethodInstructions instructions={instructions} values={defaultValues} className="custom-class" />,
      );
