...
const WhoAreFiscalHosts = () => {
  ...
  return (
    <Flex flexDirection="column" alignItems="center" px="16px" mt="80px">
      ...
      >
        <Box width={[null, '392px', '396px', null, '448px']}>
          <H2
            color="color.800"
        ...
        <Box
          ml={[5, null, null, null, '77px']}
          my="26px"
          width={['222.74px', null, null, null, '330px']}
          height={['142.48px']}
        >
          <Illustration
            src="/static/images/home/weareopen-illustration-sm.png"
      ...
      <Flex
        ...
        flexDirection={['column', 'row-reverse', null, null, 'row']}
      >
        {features.map(feature => (
          <Container
            ...
            my={3}
            mx={[null, 2, 3, null, 4]}
            // mr={[null, null, (feature.id === 'nonprofits' || feature.id === 'grantMakers')? 4 : 0]}
            // ml={[null, null, (feature.id === 'networks' || feature.id === 'entity')? 4 : 0]}
          >
            <IconWrapper my={2}>
              <Illustration
                src={`/static/images/home/documentation-illustration.png`}
                alt={`${feature.id} illustration`}
              />
            </IconWrapper>
            <Box width={[null, '306px', null, null, '297px']}>
              <H3 color="color.800" fontSize="20px" lineHeight="28px" letterSpacing="-0.008em">
                {intl.formatMessage(messages[`becomeAHost.${feature.id}`])}
              </H3>
            </Box>
            <Box mt={2} width={['288px', '306px', null, null, '289px']}>
              <P color="color.700" fontSize={['16px', '18px']} lineHeight={['24px', '26px']} fontWeight="400">
