                ...
                {({ isEditing, setValue, setUploading }) =>
                  !isEditing ? (
                    <HTMLContent
                      ...
                      ReadMoreButton={({ isOpen, ...buttonProps }) => (
                        <Button role="button" {...buttonProps} size="xs" variant="outline" className="mt-2 text-xs">
                          {isOpen ? (
                            <React.Fragment>
                            ...
                            <React.Fragment>
                              <FormattedMessage defaultMessage="Read more" id="ContributeCard.ReadMore" />
                              <ChevronDown size={12} />
                            </React.Fragment>
                          )}
                        </Button>
