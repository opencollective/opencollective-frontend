...
export default function SmallComment(props: CommentProps) {
  ...
  return (
    <div
      className={cn(
        'relative w-full border-slate-200 px-6 py-4 first:border-none [&:first-child_.timeline-indicator]:top-0 [&:last-child_.timeline-indicator]:-bottom-4 [&:last-child_.timeline-separator]:hidden',
        isPrivateNote ? 'bg-amber-50' : 'first:pt-0',
      )}
      data-cy="comment"
      id={anchorHash}
    >
