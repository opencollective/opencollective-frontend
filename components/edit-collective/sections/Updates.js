...
const messages = defineMessages({
  ...
  mainDescription: {
    ...
    defaultMessage:
      'Updates are a way to keep your community posted on your progress. They appear as a blog post on your page, and are sent by email to all your contributors. The most recent will appear in the Updates section of your main page, and all Updates will appear on {updatesLink}.',
  },
  mainDescriptionHost: {
    id: 'EditCollective.Updates.descriptionHost',
    defaultMessage:
      'Updates are a way to keep your community posted on your progress. They appear as a blog post on your page, and are sent by email to all admins of Collectives you host, your financial contributors, and your team members. The most recent will appear in the Updates section of your main page, and all Updates will appear on {updatesLink}.',
  },
  checkboxLabel: {
