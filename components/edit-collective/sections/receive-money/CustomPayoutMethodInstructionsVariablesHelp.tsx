...
type CustomPayoutMethodInstructionsVariablesHelpProps = {
 ...
 */
export const CustomPayoutMethodInstructionsVariablesHelp = ({
  variables,
}: CustomPayoutMethodInstructionsVariablesHelpProps) => {
  return (
    <div className="mb-2">
