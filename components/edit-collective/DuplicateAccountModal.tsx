  ...
  return (
    <StyledModal width="570px" onClose={onClose}>
      <ModalHeader onClose={onClose}>
        <FormattedMessage defaultMessage="Duplicate {accountName}" values={{ accountName }} />
      </ModalHeader>
      {loading ? (
        <Loading />
      ) : error ? (
            ...
            try {
              ...
              toast({
                ...
                message: intl.formatMessage(
                  { defaultMessage: '{accountName} has been duplicated' },
              ...
              <ModalBody>
                <div className="mt-6 space-y-4">
                  <p className="text-base font-semibold">
                    <FormattedMessage defaultMessage="New profile information" />
                  </p>
                  <StyledInputFormikField name="newName" label={intl.formatMessage({ defaultMessage: 'Name' })} />
                  <StyledInputFormikField
                    name="newSlug"
                    label={intl.formatMessage({ defaultMessage: 'Handle' })}
                  ...
                  <p className="text-base font-semibold">
                    <FormattedMessage defaultMessage="Settings to copy from {accountName}" values={{ accountName }} />
                  </p>
                    ...
                    {({ field }) => (
                      <div className="flex items-center gap-2">
                        ...
                        <label htmlFor={field.id} className="cursor-pointer font-normal">
                          <FormattedMessage defaultMessage="Admins" /> ({account.admins.totalCount})
                        </label>
                        <span className="text-sm italic">
                          - <FormattedMessage defaultMessage="admins duplication is mandatory" />
                        </span>
                      </div>
                    )}
                  </StyledInputFormikField>
                    ...
                    <StyledInputFormikField name="include.tiers">
                      {({ field }) => (
                        <div className="flex items-center gap-2">
                          ...
                          <label htmlFor={field.id} className="cursor-pointer font-normal">
                            {account.type === 'EVENT' ? (
                              <FormattedMessage defaultMessage="Tiers & Tickets" />
                            ) : (
                    ...
                    <StyledInputFormikField name="include.projects">
                      {({ field }) => (
                        <div className="flex items-center gap-2">
                          ...
                          />
                          <label htmlFor={field.id} className="cursor-pointer font-normal">
                            <FormattedMessage defaultMessage="Projects" /> ({account.activeProjects.totalCount})
                          </label>
                        </div>
                      )}
                    </StyledInputFormikField>
                    ...
                    <StyledInputFormikField name="include.events">
                      {({ field }) => (
                        <div className="flex items-center gap-2">
                          ...
                          />
                          <label htmlFor={field.id} className="cursor-pointer font-normal">
                            <FormattedMessage defaultMessage="Events" /> ({account.activeEvents.totalCount})
                          </label>
                        </div>
                      )}
                    </StyledInputFormikField>
