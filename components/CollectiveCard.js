    ...
    return (
      <Link href={route} target="_top">
        <CardWrapper className={`CollectiveCard ${collective.type}`} {...this.props}>
          <Container position="relative" overflow="hidden" width="100%" height="140px" borderBottom="5px solid #46b0ed">
            <Container
              position="absolute"
              top="0"
              left="0"
          ...
          <Container padding="10px" minHeight="11px">
          ...
          <Container fontSize="11px" width="100%" minHeight="60px" textAlign="center">
