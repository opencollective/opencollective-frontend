...
export default function AcceptContributionsThroughAFiscalHost(props: StartAcceptingFinancialContributionsPageProps) {
  const intl = useIntl();
  ...
  return (
    <Flex px={2} my={5} alignItems="center" flexDirection="column">
      ...
      <Box mt={4} width={['100%', '100%', '90%', '927px']}>
