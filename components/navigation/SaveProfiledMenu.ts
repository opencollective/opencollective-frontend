...
import { Book, Circle, FlaskConical, Home, LifeBuoy, LogOut, PocketKnife, Settings, User } from 'lucide-react';
...
import ProfileMenuMemberships from './OldProfileMenuMemberships';
          ...
          <Flex py="12px" flex={1} flexDirection="column" overflowY="auto">
            <Flex pb="12px" flexDirection="column">
              ...
              <DrawerMenuItem href="/opencollective/root-actions" onClick={onClose}>
                <Flex alignItems="center" gridGap={2}>
                  <Book size={16} />
                  <FormattedMessage id="RootActions" defaultMessage="Documentation" />
                </Flex>
              </DrawerMenuItem>
              <DrawerMenuItem href="/opencollective/root-actions" onClick={onClose}>
                <Flex alignItems="center" gridGap={2}>
                  <Circle size={16} />
                  <FormattedMessage id="RootActions" defaultMessage="Open Collective Homepage" />
                </Flex>
              </DrawerMenuItem>
            </Flex>
