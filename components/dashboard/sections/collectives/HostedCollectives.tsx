...
import type { Account, Collective, HostedCollectivesQueryVariables } from '../../../../lib/graphql/types/v2/graphql';
...
import CreateCollectiveModal from './CreateCollectiveModal';
