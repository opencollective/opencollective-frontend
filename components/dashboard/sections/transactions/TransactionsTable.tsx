...
import { useTransactionActions } from '../../../../lib/actions/useTransactionActions';
...
const cols = {
  ...
  actions: {
    ...
    meta: { className: 'w-16' },
    enableHiding: false,
    cell: ({ table, row, actionsMenuTriggerRef }) => {
      return (
...
export default function TransactionsTable({
  ...
  const { openDrawer, drawerProps } = useDrawer({
    ...
    onOpen: ({ id }) => queryFilter.setFilter('openTransactionId', id),
    onClose: () => queryFilter.setFilter('openTransactionId', undefined),
  });
