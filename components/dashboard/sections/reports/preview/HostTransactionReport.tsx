...
import { buildReportGroups, filterToTransactionsFilterValues } from './helpers';
...
const HostTransactionReport = ({ accountSlug: hostSlug, subpath }: DashboardSectionProps) => {
  ...
  const hostTransactionsQueryFilter = useQueryFilter({
    ...
    filters: {},
    skipRouter: true, // we don't want to update the URL
  });
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button size="sm" variant="outline">
                    <FormattedMessage defaultMessage="Export" /> <ChevronDown size={18} />
                  </Button>
                </DropdownMenuTrigger>
                <DropdownMenuContent align="end">
                  ...
                  {/* <DropdownMenuItem>
                    <FormattedMessage defaultMessage="Export report CSV" />
                  </DropdownMenuItem> */}
                </DropdownMenuContent>
              </DropdownMenu>
                              ...
                              <div className="group relative flex justify-between gap-3 py-1 pl-6 pr-3 text-sm hover:bg-muted has-[[data-state=open]]:bg-muted sm:pl-10 sm:pr-4">
                                ...
                                <div className="flex shrink-0 items-center justify-end gap-0">
                                  ...
                                  <DropdownMenu>
                                    ...
                                    <DropdownMenuContent align="end">
                                      <DropdownMenuItem onClick={() => viewTransactions(subPart.filter)}>
                                        {/* <Link
                                          href={{
                                      ...
                                      <DropdownMenuItem onClick={() => openExportTransactionsModal(subPart.filter)}>
                                        <FormattedMessage defaultMessage="Export transactions" />
                                      </DropdownMenuItem>
                                    </DropdownMenuContent>
                                  </DropdownMenu>
