...
import { Check, ChevronDown, ChevronUp, LockKeyhole, LockKeyholeOpen } from 'lucide-react';
    ...
    <div>
      <div className="flex flex-row items-center gap-4">
        <div className="flex h-8 w-8 items-center justify-center">
          ...
          >
            {props.requiresUpgrade ? <LockKeyhole size="18px" /> : props.completed ? <Check size="18px" /> : null}
          </Label>
        </div>
        ...
        <div className="ml-12">
          ...
          {props.requiresUpgrade ? (
            <Button className="mt-2" variant="outline" asChild>
              <Link href={getDashboardRoute(props.account, 'platform-subscription')}>
                <FormattedMessage defaultMessage="Manage my Subscription" id="aCEhyn" />
              </Link>
            </Button>
          ) : (
            props.action && (
