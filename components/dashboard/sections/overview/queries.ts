...
import { accountHoverCardFields, AccountHoverCardFragment } from '../../../AccountHoverCard';
import { transactionsTableQueryCollectionFragment } from '../transactions/queries';

import { AccountProfileCardFragment } from './AccountProfileCard';
...
export const overviewMetricsQuery = graphql(
  `
  ...
  `,
  [AccountHoverCardFragment, AccountProfileCardFragment],
);
