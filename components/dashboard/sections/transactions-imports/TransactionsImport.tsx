...
import { R } from '@styled-icons/fa-solid';
...
const DEFAULT_PAGE_SIZE = 10; // TODO: 50
...
const queryFilterSchema = z.object({
  ...
  status: z.nativeEnum(TransactionsImportRowStatus).optional(),
...
const MultiPagesRowSelectionInitialState: MultiPagesRowSelectionState = {
  rows: {},
  includeAllPages: false,
};

const multiPagesRowSelectionReducer = (
...
export const TransactionsImport = ({ accountSlug, importId }) => {
  ...
  const queryFilter = useQueryFilter({ schema: queryFilterSchema, filters, views: queryFilterViews });
