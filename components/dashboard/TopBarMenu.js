...
const Menu = ({ isAccountantOnly }) => {
  ...
  return (
    <Flex flex={1}>
      {/** Host dashboard */}
      <MenuGroup if={isHost}>
        <MenuLink section={COLLECTIVE_SECTIONS.OVERVIEW} icon={{ component: Home }} />
        ...
        <MenuLink section={HOST_DASHBOARD_SECTIONS.REPORTS} icon={{ component: Chart }} />
      ...
      <MenuGroup if={!isHost}>
        ...
        <MenuLink
          ...
          icon={{ component: Home }}
          if={
            isIndividual || LoggedInUser?.hasPreviewFeatureEnabled(PREVIEW_FEATURE_KEYS.DASHBOARD_COLLECTIVE_OVERVIEW)
          }
        />
