...
// import { Command, CommandEmptyC, ommandList, CommandGroup, CommandInput, CommandItem } from '../ui/CommandMenu';
...
// export default function FilterCombo({ filterOptions, filter, onChange }) {
//   const active = false;
