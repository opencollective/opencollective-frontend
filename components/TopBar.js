...
const TopBar = ({ showSearch, menuItems, showProfileAndChangelogMenu, LoggedInUser }) => {
  ...
  return (
    ...
    >
      ...
      <Flex alignItems="center" justifyContent={LoggedInUser ? 'start' : 'center'} flex="1 1 auto">
        {!LoggedInUser || inMarketingPage ? (
          <Hide xs sm>
