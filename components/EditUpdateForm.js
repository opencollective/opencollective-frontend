      ...
      <UpdateFormWrapper className={`EditUpdateForm ${this.props.mode}`}>
        <form data-cy="edit-update-form" onSubmit={this.onSubmit}>
          <Container margin="auto 0">
            <Container width={1}>
              <Container mb={2} mt={2} fontWeight="500" fontSize="16px" lineHeight="1.7">
          ...
          <Container width={1}>
            <Container fontWeight="500" mb={2} mt={3} fontSize="16px" lineHeight="1.7">
