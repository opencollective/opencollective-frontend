...
const requiresAddress = values => {
  return values.type === expenseTypes.INVOICE && values.payee.type !== CollectiveType.COLLECTIVE;
};
...
export const prepareExpenseForSubmit = expenseData => {
  ...
  const payeeLocation = requiresAddress(expenseData)
...
const ExpenseFormBody = ({
  ...
  const stepOneCompleted =
    ...
    (isReceipt || values.payee.type === CollectiveType.COLLECTIVE
      ? true
