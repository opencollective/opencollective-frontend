            ...
            <Link href="/organizations/new">
              <Flex alignItems="center" px={['16px', '13px']} py="13px">
                <Box width="100%">
                  ...
                  <Flex fontSize="15px" fontWeight="500" color="black.700" lineHeight="22px" pt="14px">
                    <FormattedMessage
                      defaultMessage="Create a profile for your business to appear as financial contributor, enable your employees to contribute on behalf of your company, and more."
                      id="mntSey"
                    />
                  </Flex>
                </Box>
          ...
          <Flex justifyContent="space-between" width={['100%', '472px']} pl="13px" pr="13px" pb="32px" pt="40px">
            {LoggedInUser && (
              <StyledLink href={`/dashboard/${LoggedInUser.collective?.slug}/info`}>
                <FormattedMessage defaultMessage="Go to settings" id="rqE6vX" />
              </StyledLink>
            )}
