  ...
  ${props =>
    ...
    css`
      body {
        ...
        padding: 0;
        margin: 0;
        font-family: ${props.style.body && `${props.style.body.fontFamily},`} 'Inter', Helvetica, sans-serif;
        font-weight: 300;
        font-size: 1rem;
        line-height: 1.5;
        overflow-x: hidden;
      ...
      a {
        ...
        color: ${(props.style.a && props.style.a.color) || '#46b0ed'};
        cursor: pointer;
        font-size: 14px;
      }
    `}
...
class BannerIframe extends React.Component {
  ...
  render() {
    ...
    return (
      <IFrameContainer ref={node => (this.node = node)}>
        <Head>
