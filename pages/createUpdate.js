...
import { updatesSectionQuery } from '../components/collective-page/sections/Updates';
...
import { updatesQuery } from '../components/UpdatesWithData';
  ...
  createUpdate = async update => {
    ...
    try {
      ...
      const res = await this.props.createUpdate({
        variables: { update },
        refetchQueries: [
          { query: updatesQuery, context: API_V2_CONTEXT, variables: { collectiveSlug: this.props.slug } },
          { query: updatesSectionQuery, variables: { slug: this.props.slug, onlyPublishedUpdates: true } },
        ],
      });
