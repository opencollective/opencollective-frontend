  ...
  async claimPaymentMethod() {
    ...
    try {
      if (this.props.LoggedInUser) {
        ...
        this.props.router.push({ pathname: '/redeemed', query: { code, collectiveSlug: this.props.collectiveSlug } });
        return;
      } else {
...
export default injectIntl(withRouter(withUser(addGraphql(RedeemPage))));
