...
import SignInV2 from '../../components/SignInV2';

<Meta title="Design system/SignInV2" component={SignInV2} />
...
<Canvas>
  <Story name="Loading / Submitting">
    {() => {
      return (
        <SignInV2 loading onSubmit={() => {}} onSecondaryAction={() => {}} email="test+betree@opencollective.com" />
      );
    }}
  </Story>
</Canvas>
    ...
    {() => {
      return (
        <SignInV2
          ...
          onSecondaryAction={() => {}}
          unknownEmail
          email="test+betree@opencollective.com"
        />
      );
    }}
  </Story>
