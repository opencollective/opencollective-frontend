...
module.exports = {
  up: (queryInterface, sequelize) => {
    ...
    const botSlug = 'w9bot';
    return queryInterface.sequelize.query(`SELECT * FROM "Collectives" WHERE slug=:slug`, {
