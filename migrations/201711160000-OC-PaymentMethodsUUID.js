...
const updatePaymentMethods = (sequelize) => {
  ...
  return sequelize.query(`SELECT id, service, name FROM "PaymentMethods" WHERE uuid IS NULL`, { type: sequelize.QueryTypes.SELECT })
...
module.exports = {
  up: (queryInterface, DataTypes) => {
      ...
      return updatePaymentMethods(queryInterface.sequelize)
      .then(() => {
