...
const populateCompanies = (sequelize) => {
  ...
  const updateUser = (userCollective) => {
    ...
    if (DRY_RUN) {
      ...
      return sequelize.query(`UPDATE "Collectives" SET company=:company WHERE id=:id`, { replacements: userCollective })
    }
  }
  ...
  `, { type: sequelize.QueryTypes.SELECT }).map(updateUser)
}

module.exports = {
  up: function (queryInterface, Sequelize) {
    return queryInterface.addColumn('Collectives', 'company', {
        type: Sequelize.STRING
      })
      .then(() => queryInterface.addColumn('CollectiveHistories', 'company', {
        type: Sequelize.STRING
      }))
  ...
  down: function (queryInterface, Sequelize) {
    return queryInterface.removeColumn('Collectives', 'company')
      .then(() => queryInterface.removeColumn('CollectiveHistories', 'company'))
  }
};
