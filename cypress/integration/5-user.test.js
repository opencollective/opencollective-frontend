...
describe('user profile page', () => {
  it('shows the collectives backed by the user', () => {
    ...
    cy.get('#backer');
    cy.get('#admin.organization .subtitle').contains(
      "I'm an administrator of these 2 organizations",
    );
    cy.get('#admin.organization .CollectiveCard').should('have.length', 2);
    cy.get('#admin.collective .subtitle').contains(
      "I'm a core contributor of these 2 collectives",
    );
