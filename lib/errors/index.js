...
export const ERROR = {
  ...
  LEGAL_NAME_NOT_MATCH_BANK_ACCOUNT_NAME: 'LEGAL_NAME_NOT_MATCH_BANK_ACCOUNT_NAME',
...
const msg = {
  ...defineMessages({
    ...
    [ERROR.LEGAL_NAME_NOT_MATCH_BANK_ACCOUNT_NAME]: {
      id: 'Error.LegalNameNotMatchBankAccountName',
