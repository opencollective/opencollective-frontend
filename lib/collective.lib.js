...
export const accountSupportsGrants = (account, host) => {
  const accountHasGrantFlag = get(account, 'settings.expensesTypes.hasGrant');
  const hostHasGrantFlag = get(host, 'settings.expensesTypes.hasGrant');
...
export const accountSupportsInvoices = (account, host) => {
  const accountHasInvoiceFlag = get(account, 'settings.expensesTypes.hasInvoice');
  const hostHasInvoiceFlag = get(host, 'settings.expensesTypes.hasInvoice');
...
export const accountSupportsReceipts = (account, host) => {
  const accountHasReceiptFlag = get(account, 'settings.expensesTypes.hasReceipt');
  const hostHasReceiptFlag = get(host, 'settings.expensesTypes.hasReceipt');
