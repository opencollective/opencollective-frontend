...
type AccountWithType = { type: AccountType };

/** Narrows any account union to its Individual members */
export function isIndividualAccount<T extends AccountWithType>(
...
export function isOrganizationAccount<T extends AccountWithType>(
  account: T | null | undefined,
...
export function isEventAccount<T extends AccountWithType>(
  account: T | null | undefined,
...
export function isProjectAccount<T extends AccountWithType>(
  account: T | null | undefined,
...
export function isChildAccount<T extends AccountWithType>(
  account: T | null | undefined,
...
export function isCollectiveAccount<T extends AccountWithType>(
  account: T | null | undefined,
...
export function isFundAccount<T extends AccountWithType>(
  account: T | null | undefined,
...
export function isCollectiveOrFundAccount<T extends AccountWithType>(
  account: T | null | undefined,
...
export function isVendorAccount<T extends AccountWithType>(
  account: T | null | undefined,
...
export function isHostableAccount<T extends AccountWithType>(
  account: T | null | undefined,
