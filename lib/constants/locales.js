...
export default {
  ...
  de: { name: 'German', nativeName: 'Deutsch', completion: '73%' },
  he: { name: 'Hebrew', nativeName: 'עברית', completion: '68%' },
  ...
  pl: { name: 'Polish', nativeName: 'Polski', completion: '91%' },
  pt: { name: 'Portuguese', nativeName: 'Português', completion: '20%' },
  ru: { name: 'Russian', nativeName: 'Русский', completion: '36%' },
  'sk-SK': { name: 'Slovak', nativeName: 'Slovensky', completion: '78%' },
  es: { name: 'Spanish', nativeName: 'Español', completion: '97%' },
  'sv-SE': { name: 'Swedish', nativeName: 'Svenska', completion: '80%' },
