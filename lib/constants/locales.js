...
export default {
  ...
  he: { name: 'Hebrew', nativeName: 'עברית', completion: '65%' },
  ...
  pl: { name: 'Polish', nativeName: 'Polski', completion: '87%' },
  pt: { name: 'Portuguese', nativeName: 'Português', completion: '20%' },
  ru: { name: 'Russian', nativeName: 'Русский', completion: '36%' },
  'sk-SK': { name: 'Slovak', nativeName: 'Slovensky', completion: '75%' },
  es: { name: 'Spanish', nativeName: 'Español', completion: '98%' },
  'sv-SE': { name: 'Swedish', nativeName: 'Svenska', completion: '76%' },
  uk: { name: 'Ukrainian', nativeName: 'Українська', completion: '58%' },
};
