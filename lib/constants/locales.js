...
export default {
  ...
  'pt-BR': { name: 'Brazilian Portuguese', nativeName: 'Português brasileiro', completion: '100%' },
  ca: { name: 'Catalan', nativeName: 'Català', completion: '14%' },
  zh: { name: 'Chinese', nativeName: '中文', completion: '48%' },
  ...
  de: { name: 'German', nativeName: 'Deutsch', completion: '100%' },
  ...
  'sk-SK': { name: 'Slovak', nativeName: 'Slovensky', completion: '43%' },
