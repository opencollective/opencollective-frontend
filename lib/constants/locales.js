...
export default {
  ...
  'pt-BR': { name: 'Brazilian Portuguese', nativeName: 'Português brasileiro', completion: '75%' },
  ca: { name: 'Catalan', nativeName: 'Català', completion: '15%' },
  zh: { name: 'Chinese', nativeName: '中文', completion: '50%' },
  cs: { name: 'Czech', nativeName: 'čeština', completion: '21%' },
  nl: { name: 'Dutch', nativeName: 'Nederlands', completion: '32%' },
  ...
  'sv-SE': { name: 'Swedish', nativeName: 'Svenska', completion: '49%' },
