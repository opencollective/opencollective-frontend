...
export default {
  ach: { name: 'Crowdin', nativeName: 'Crowdin', completion: '???%' },
  ...
  ca: { name: 'Catalan', nativeName: 'Català', completion: '8%' },
  ...
  fr: { name: 'French', nativeName: 'Français', completion: '54%' },
  de: { name: 'German', nativeName: 'Deutsch', completion: '38%' },
  ...
  pl: { name: 'Polish', nativeName: 'Polski', completion: '93%' },
  ...
  'sv-SE': { name: 'Swedish', nativeName: 'Svenska', completion: '95%' },
  uk: { name: 'Ukrainian', nativeName: 'Українська', completion: '46%' },
};
