...
// This query is referenced by its name in `components/edit-collective/EditConnectedAccount.js` line 165, so be careful when renaming it
export const editCollectiveQuery = gqlV1/* GraphQL */ `
  query EditCollective($slug: String) {
...
export const collectiveSettingsQuery = gqlV1/* GraphQL */ `
  query CollectiveSettings($slug: String) {
    Collective(slug: $slug) {
      id
      settings
    }
