...
export type Order = {
  ...
  paymentMethod?: Maybe<PaymentMethod>;
  /** Date the funds should arrive. */
  pendingContributionData?: Maybe<Scalars['JSON']>;
...
export type PendingOrderCreateInput = {
  ...
  /** Custom data related to the Pending Order */
  customData?: InputMaybe<Scalars['JSON']>;
