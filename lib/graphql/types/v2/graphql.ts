...
export type AccountMembersArgs = {
  ...
  includeInheritedMembers?: InputMaybe<Scalars['Boolean']>;
  limit?: Scalars['Int'];
  offset?: Scalars['Int'];
  role?: InputMaybe<Array<InputMaybe<MemberRole>>>;
};
