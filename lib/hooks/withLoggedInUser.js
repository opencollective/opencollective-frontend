...
import { API_V1_CONTEXT } from '../graphql/helpers';
  ...
  return class withLoggedInUser extends React.Component {
    ...
    getLoggedInUserFromServer = () => {
      return this.props.client
        .query({ query: loggedInUserQuery, context: API_V1_CONTEXT, fetchPolicy: 'network-only' })
        .then(result => {
    ...
    getLoggedInUserFromCache = () => {
      ...
      return !result.LoggedInUser ? null : new LoggedInUser(result.LoggedInUser);
    };
