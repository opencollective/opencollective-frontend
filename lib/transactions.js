...
export const renderDetailsString = ({ amount, platformFee, hostFee, paymentProcessorFee, netAmount, isCredit }) => {
  let tAmount = formatCurrency(Math.abs(amount.valueInCents), amount.currency);
  let nAmount =
    netAmount &&
  ...
  [tAmount, nAmount] = !isCredit && nAmount ? [nAmount, tAmount] : [tAmount, nAmount];
