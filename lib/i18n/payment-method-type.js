...
const i18nTypes = defineMessages({
  ADAPTIVE: { defaultMessage: 'PayPal Adaptive', id: 'wFUChi' },
  ...
  BANK_TRANSFER: { defaultMessage: 'Bank Transfer (Wise)', id: 'ZJeFvb' },
  ...
  LINK: { defaultMessage: 'Link (Stripe)', id: 'WYdbkR' },
  MANUAL: { id: 'Payout.Manual', defaultMessage: 'Manual' },
  PAYMENT: { defaultMessage: 'PayPal payment', id: 'Ed6cRE' },
  PAYOUT: { defaultMessage: 'PayPal payout', id: 'AUPY+T' },
  PREPAID: { id: 'Prepaid', defaultMessage: 'Prepaid Card' },
  SEPA_DEBIT: { id: 'SEPADebit', defaultMessage: 'SEPA Debit' },
  SUBSCRIPTION: { defaultMessage: 'PayPal subscription', id: 'Clvp6T' },
