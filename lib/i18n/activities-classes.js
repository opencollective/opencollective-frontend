...
export const ActivityClassesI18N = defineMessages({
  ...
  'activitiesUpdates.description': {
    ...
    defaultMessage: 'Receive emails when a new update is published or comments added to a conversation.',
  },
  'virtualCards.title': {
  ...
  'virtualCards.description': {
    ...
    defaultMessage:
      'Receive emails virtual cards are requested, assigned and when a charge is declined or it is missing its receipt.',
  },
  'fundsEvents.title': {
  ...
  'fundsEvents.description': {
    ...
    defaultMessage: 'Recevie emails when a fund or event is created, tickets confirmation and events reminders.',
  },
  'reports.title': {
    id: 'reports.title',
  ...
  'reports.description': {
    ...
    defaultMessage: 'Receive monthly reports of the activity of these collectives',
  },
});
