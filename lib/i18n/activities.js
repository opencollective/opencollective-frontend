...
export const ActivityDescriptionI18n = defineMessages({
  ...
  COLLECTIVE_CORE_MEMBER_REMOVED: {
    defaultMessage:
      '<FromAccount></FromAccount> membership to <Account></Account> as a <MemberRole></MemberRole> has been removed',
  },
  // Transactions
  ...
  VIRTUAL_CARD_CHARGE_DECLINED: {
    defaultMessage: 'virtualcard.charge.declined',
  },
  // Connected accounts
  ...
  ORDER_CANCELED_ARCHIVED_COLLECTIVE: {
    defaultMessage: '<Order>Order</Order> cancelled on <Account></Account> (archived)',
  },
  ORDER_PROCESSING: {
    defaultMessage: '<Order>Order</Order> from <FromAccount></FromAccount> to <Account></Account> set as processing',
  },
  ORDER_PROCESSING_CRYPTO: {
    defaultMessage:
      'Crypto <Order>order</Order> from <FromAccount></FromAccount> to <Account></Account> set as processing',
  },
  ORDER_PENDING_CONTRIBUTION_NEW: {
    defaultMessage: 'New pending <Order>order</Order> from <FromAccount></FromAccount> to <Account></Account>',
  },
  ORDER_PENDING_CONTRIBUTION_REMINDER: {
    defaultMessage: 'Sent reminder to <FromAccount></FromAccount> about <Order>order</Order> to <Account></Account>',
  },
  BACKYOURSTACK_DISPATCH_CONFIRMED: {
    defaultMessage: 'BackYourStack dispatch confirmed for <Account></Account>',
  },
  PAYMENT_FAILED: {
    defaultMessage: 'Payment from <FromAccount></FromAccount> to <Account></Account> for <Order>order</Order> failed',
  },
  PAYMENT_CREDITCARD_CONFIRMATION: {
    defaultMessage: 'Asked for credit card confirmation for <Order>order</Order> on <Account></Account>',
  },
