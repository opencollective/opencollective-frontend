  ...
  return class WithData extends React.Component {
    static async getInitialProps(context) {
      ...
      if (has(ctx, 'query.slug')) {
        debugPerformance('withData: getInitialProps', get(ctx, 'query.slug'));
      }
      ...
      try {
        ...
        if (has(ctx, 'query.slug')) {
          debugPerformance('withData: getDataFromTree', get(ctx, 'query.slug'));
        }
    ...
    render() {
      if (has(this.props, 'router.query.slug')) {
        debugPerformance('withData: getInitialProps', get(this.props, 'router.query.slug'));
      }
