...
const FeatureAllowedForTypes = {
  ...
  [FEATURES.RECEIVE_EXPENSES]: [CollectiveType.COLLECTIVE, CollectiveType.EVENT, CollectiveType.FUND],
...
const hasFeature = (collective, feature) => {
  ...
  if (collective.type === CollectiveType.FUND || collective.settings?.fund === true) {
