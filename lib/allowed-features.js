 ...
 */
export const isFeatureAllowedForCollectiveType = (collective, feature) => {
...
export const getFeatureStatus = (collectiveFeatures, feature) => {
  const featureStatus = collectiveFeatures[feature];
...
const hasFeature = (collective, feature) => {
  ...
  if (collective.features) {
    const featureStatus = getFeatureStatus(collective.features, feature);
