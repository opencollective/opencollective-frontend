...
const sortSteps = (steps: Step[]) => orderBy(steps, ['requiresUpgrade', 'completed'], ['desc', 'desc']);
      ...
      steps: sortSteps([
        {
          ...
          requiresUpgrade: !planFeatures?.RECEIVE_FINANCIAL_CONTRIBUTIONS,
          action: {
        ...
        },
        {
          ...
          requiresUpgrade: !planFeatures?.TRANSFERWISE,
          action: {
        ...
        },
        {
          ...
          requiresUpgrade: !planFeatures?.CHART_OF_ACCOUNTS,
          action: {
    ...
    },
    {
      ...
      steps: sortSteps([
        ...
        },
        {
          ...
          requiresUpgrade: !planFeatures?.CHARGE_HOSTING_FEES,
          action: {
        ...
        },
        {
          ...
          requiresUpgrade: !planFeatures?.RECEIVE_HOST_APPLICATIONS,
          action: {
