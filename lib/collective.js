...
export const hasAccountMoneyManagement = c => c.isHost === true;

/* Returns true if the account has Hosting activated. */
export const hasAccountHosting = c =>
  c.isHost === true && c.type !== 'COLLECTIVE' && c.settings?.canHostAccounts !== false;
