...
class OrderForm extends React.Component {
  ...
  constructor(props) {
    ...
    this.messages = defineMessages({
      ...
      'paymentMethod.manual': { id: 'paymentMethod.manual', defaultMessage: 'bank transfer' },
      ...
      'email.description.login': { id: 'signin.login.description', defaultMessage: 'Welcome back! Click on "Login" (or hit Enter) and we will send you a link to login by email.' },
