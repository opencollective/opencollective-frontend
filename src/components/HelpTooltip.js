  ...
  render() {
    return (
      <div className="HelpTooltip">
        ...
        { this._isMounted &&
          <div>
            <a data-tip data-for={this.id}><img src={this.iconsrc} className="helpIcon" /></a>
            <ReactTooltip id={this.id} type="info" effect="solid" place="bottom" className="customTooltip" overlayStyle={this.overlayStyle}>
              {this.props.children}
            </ReactTooltip>
          </div>
        }
