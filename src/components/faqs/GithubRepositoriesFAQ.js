...
Note that in that case you will be responsible for doing the accounting. It will also be much harder to receive donations from large companies since you won’t be in their trusted vendors list."
            />
          </Content>
        </Entry>
      </Container>
