...
class HostsCover extends React.Component {
  ...
  render() {
    ...
    const findOutMoreLink = <CoverSmallCTA><Link route="/faq/becoming-an-open-collective-host">{findOutMoreMessage}</Link></CoverSmallCTA>;
    const descriptionNode = <FormattedMessage id="hosts.description" defaultMessage="Hosts are legal entities that collect money on behalf of open collectives so that they don't have to worry about accounting, taxes, etc. Some also provide extra services. {findOutMoreLink}" values={{ findOutMoreLink }} />;
