...
class Header extends React.Component {
  ...
  constructor(props) {
    ...
    const meta = {
      ...
      'og:image': image ? image : 'https://opencollective.com/static/images/opencollectiveicon-240x240@2x.png',
      ...
      'twitter:image': image ? image : 'https://opencollective.com/static/images/opencollectiveicon-240x240@2x.png',
      'og:title': title ? `${title} - Open Collective` : 'Open Collective',
    };
