...
describe("TransactionsExportPopoverAndButton component", () => {
  it("TransformResultsInCSV", async () => {
    ...
    expect(csv).toEqual([
      "Transaction Description,User Name,User Profile,Transaction Date,Collective Currency,Host Currency,Transaction Amount,Host Fee (USD),Open Collective Fee (USD),Payment Processor Fee (USD),Net Amount (BRL),Subscription Interval,Order Date",
