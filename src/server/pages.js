...
pages
  ...
  .add('orderCollectiveTier', '/:collectiveSlug/order/:TierId/:amount?/:interval?', 'orderTier')
  .add('orderEventTier', '/:collectiveSlug/events/:eventSlug/order/:TierId/:amount?/:interval?', 'orderTier')
